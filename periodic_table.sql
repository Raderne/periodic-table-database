...
--
-- Name: elements ck_elements_symbol_name_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT ck_elements_symbol_name_unique UNIQUE (symbol, name);
